...
<div class="container">
	...
	<div class="row">
	  ...
	  <div class="col-md-6">
	  	...
	  	<div>
	  	<form id="checkout" method="post" action="hosted-fields-address-checkout.php">
	  		<h5>Address</h5>
	  		<div class="form-group">
	  			<label>First Name</label>
			    <input class="form-control" type="text" id="first_name" name="first_name" value="Paul"></input>
			</div>
	  		<div class="form-group">
	  			<label>Last Name</label>
			    <input class="form-control"  type="text" id="last_name" name="last_name" value="Simth"></input>
			</div>
	  		<div class="form-group">
	  			<label>Company</label>
			    <input class="form-control"  type="text" id="company" name="company" value="Braintree"></input>
			</div>
	  		<div class="form-group">
	  			<label>Street 1</label>
			    <input class="form-control"  type="text" id="street1" name="street1" value="1 E Main St"></input>
			</div>
	  		<div class="form-group">
	  			<label>Street 2</label>
			    <input class="form-control"  type="text" id="street2" name="street2" value="Suite 230"></input>
			</div>
	  		<div class="form-group">
	  			<label>City</label>
			    <input class="form-control"  type="text" id="city" name="city" value="Chicago"></input>
			</div>
	  		<div class="form-group">
	  			<label>State</label>
			    <input class="form-control"  type="text" id="state" name="state" value="IL"></input>
			</div>
	  		<div class="form-group">
	  			<label>Postal Code</label>
			    <input class="form-control"  type="text" id="postal" name="postal" value="12358"></input>
			</div>
	  		<div class="form-group">
	  			<label>country</label>
